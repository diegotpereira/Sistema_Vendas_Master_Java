...
public class CadastroCliente extends javax.swing.JInternalFrame {
    ...
    private boolean validarFormulario() {
      ...
      if (ftfCpf.getText().trim().length() != 14) {
          JOptionPane.showMessageDialog(this, "CPF invÃ¡lido.", "Alerta", JOptionPane.WARNING_MESSAGE);
          ftfCpf.requestFocus();
          return false;
      }
      if (((Date) ftfDataNascimento.getValue()).after(new Date())) {
          JOptionPane.showMessageDialog(this, "Data de nascimento invÃ¡lida.", "Alerta", JOptionPane.WARNING_MESSAGE);
